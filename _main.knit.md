...
![](_main_files/figure-latex/unnamed-chunk-6-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-9-3.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-10-1.pdf)<!-- --> 

```r
 hist(totalWaiting,main="total number waiting")
```

![](_main_files/figure-latex/unnamed-chunk-10-2.pdf)<!-- --> 

```r
 hist(avgWaiting,main="avg. waiting (min)")
```

![](_main_files/figure-latex/unnamed-chunk-10-3.pdf)<!-- --> 

```r
 hist(closing-420,main="closing time")
```

![](_main_files/figure-latex/unnamed-chunk-10-4.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-11-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-11-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-20-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-21-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-23-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-23-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-26-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-27-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-28-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-28-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-30-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-31-2.pdf)<!-- --> 
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.1776  0.4417  0.5286  0.5477  0.6375  1.2756
```
...
![](_main_files/figure-latex/unnamed-chunk-35-1.pdf)<!-- --> 
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2037  0.4581  0.5499  0.5689  0.6598  1.3574
```
...
![](_main_files/figure-latex/unnamed-chunk-36-1.pdf)<!-- --> 
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2454  0.4636  0.5554  0.5713  0.6626  1.3869
```
...
![](_main_files/figure-latex/unnamed-chunk-37-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-38-1.pdf)<!-- --> 
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2524  0.4549  0.5547  0.5715  0.6611  1.5017
```
...
![](_main_files/figure-latex/unnamed-chunk-38-2.pdf)<!-- --> 
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.3127  0.5041  0.5625  0.5721  0.6307  0.8708
```
...
![](_main_files/figure-latex/unnamed-chunk-39-1.pdf)<!-- --> 
...
```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   6.166   9.369  10.349  10.382  11.296  16.480
```
...
![](_main_files/figure-latex/unnamed-chunk-39-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-40-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-40-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-41-1.pdf)<!-- --> 

```r
 plot(y,pois.post,main="normal vs. pois likelihoods")
```

![](_main_files/figure-latex/unnamed-chunk-41-2.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-42-1.pdf)<!-- --> 
## Question 6{-}
...
![](_main_files/figure-latex/unnamed-chunk-43-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-44-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/unnamed-chunk-48-1.pdf)<!-- --> 
...
![](_main_files/figure-latex/q11-1.pdf)<!-- --> 
