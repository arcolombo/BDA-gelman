...
\$\$
d\textsuperscript{2/d\theta}2 log p(\theta\textbar y) = d\textsuperscript{2/d\theta}2 log p(\hat{\theta}) + \sum\emph{\{i=1\}\^{}n d\textsuperscript{2/d\theta}2 log p(y\_i \textbar{} \theta)}\{\theta=\hat{\theta}\}
