...
\begin{verbatim}
##       5%      25%      50%      75%      95% 
## 139.6388 156.0005 167.5896 179.5002 197.7604
\end{verbatim}
...
## -4233.639    -0.419     0.503     2.788     1.611  7422.366
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    6.00   20.00   24.00   23.79   27.00   47.00
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   3.924  20.793  24.260  24.261  27.716  44.834
\end{verbatim}
...
\begin{verbatim}
## average predictive value from posterior:23.7855
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   611.0   671.0   690.0   689.8   708.0   775.0
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.1472  0.4435  0.5369  0.5600  0.6583  1.3864
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.1936  0.4414  0.5326  0.5588  0.6514  1.2785
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2350  0.4615  0.5633  0.5844  0.6852  1.2634
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2041  0.4634  0.5545  0.5693  0.6586  1.4735
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.3417  0.5091  0.5696  0.5760  0.6362  0.9737
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   6.646   9.310  10.356  10.401  11.349  14.648
\end{verbatim}
...
\begin{verbatim}
## posterior mean for A :1.335 B 11.625
\end{verbatim}
...
\begin{verbatim}
## normal approx posterior mean -0.113 std. dev 0.11
\end{verbatim}
...
\begin{verbatim}
## sample posterior mean: -0.104438
\end{verbatim}
