...
\begin{verbatim}
##       5%      25%      50%      75%      95% 
## 142.2442 157.1713 167.6872 179.0203 195.1921
\end{verbatim}
...
## -331.813   -0.637    0.450    8.095    1.493 6807.657
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    7.00   20.00   24.00   23.88   27.00   44.00
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   3.939  20.834  24.263  24.272  27.733  47.374
\end{verbatim}
...
\begin{verbatim}
## average predictive value from posterior:23.8841
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   608.0   671.0   690.0   690.6   710.0   771.0
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2076  0.4481  0.5427  0.5612  0.6581  1.2954
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2349  0.4502  0.5477  0.5637  0.6531  1.2648
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2280  0.4696  0.5646  0.5791  0.6706  1.3426
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2080  0.4546  0.5520  0.5686  0.6649  1.2970
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.3258  0.5064  0.5615  0.5688  0.6254  0.9455
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   5.629   9.482  10.335  10.377  11.232  16.465
\end{verbatim}
...
\begin{verbatim}
## posterior mean for A :1.31 B 11.622
\end{verbatim}
...
\begin{verbatim}
## normal approx posterior mean -0.106 std. dev 0.11
\end{verbatim}
...
\begin{verbatim}
## sample posterior mean: -0.109228
\end{verbatim}
...
\begin{verbatim}
## sample posterior variance: 0.007
\end{verbatim}
...
\begin{verbatim}
## sample posterior std.dev: 0.086
\end{verbatim}
...
\begin{verbatim}
## taylor approximation of std.dev using posterior sample variance: 0.086
\end{verbatim}
