...
\addcontentsline{toc}{subsection}{Question 4 (independent binomial)}
...
\addcontentsline{toc}{subsection}{Exchangeability when additional information is available on the units}
...
\addcontentsline{toc}{subsection}{Objections to exchangeable models}
...
\addcontentsline{toc}{subsection}{The full Bayesian treatment of the hierarchical model}
...
\addcontentsline{toc}{section}{The hyperprior distribution}
...
\addcontentsline{toc}{subsection}{Analytic derivation of conditional and marginal distributions}
...
\addcontentsline{toc}{subsection}{Drawing simulations from the posterior distribution}
...
\addcontentsline{toc}{subsection}{Application to the model for rat tumors}
...
\addcontentsline{toc}{subsubsection}{Q10}
...
\addcontentsline{toc}{subsubsection}{Q11}
...
\DocumentationTok{\#\# conditional expectation}

\NormalTok{mu\_hat}\OtherTok{\textless{}{-}}\ControlFlowTok{function}\NormalTok{(allsigma2j,tau2,allybarj)\{}
\NormalTok{   numer}\OtherTok{\textless{}{-}}\FunctionTok{sum}\NormalTok{( (}\DecValTok{1}\SpecialCharTok{/}\NormalTok{(allsigma2j}\SpecialCharTok{+}\NormalTok{tau2))}\SpecialCharTok{*}\NormalTok{allybarj)}
\NormalTok{   denom}\OtherTok{\textless{}{-}}\FunctionTok{sum}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{(allsigma2j}\SpecialCharTok{+}\NormalTok{tau2))}
\NormalTok{   muhat}\OtherTok{=}\NormalTok{ numer}\SpecialCharTok{/}\NormalTok{denom}
   \FunctionTok{return}\NormalTok{(muhat)}
\NormalTok{\}}

\NormalTok{conditionalExpectation}\OtherTok{\textless{}{-}}\ControlFlowTok{function}\NormalTok{(sigma2j,ybarj,tau2,allsigma2j,allybarj)\{}
\NormalTok{  muhat}\OtherTok{\textless{}{-}}\FunctionTok{mu\_hat}\NormalTok{(allsigma2j, tau2,allybarj)}
  
\NormalTok{  a}\OtherTok{\textless{}{-}}\NormalTok{((}\DecValTok{1}\SpecialCharTok{/}\NormalTok{sigma2j)}\SpecialCharTok{*}\NormalTok{ybarj)}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{sigma2j }\SpecialCharTok{+} \DecValTok{1}\SpecialCharTok{/}\NormalTok{tau2)}
\NormalTok{  b}\OtherTok{\textless{}{-}}\NormalTok{ ((}\DecValTok{1}\SpecialCharTok{/}\NormalTok{tau2)}\SpecialCharTok{*}\NormalTok{muhat)}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{sigma2j }\SpecialCharTok{+} \DecValTok{1}\SpecialCharTok{/}\NormalTok{tau2)}
\NormalTok{  cond.mean}\OtherTok{\textless{}{-}}\NormalTok{a}\SpecialCharTok{+}\NormalTok{b}
  \FunctionTok{return}\NormalTok{(cond.mean)}
\NormalTok{\}}

\NormalTok{tau\_seq }\OtherTok{=} \FunctionTok{seq}\NormalTok{(}\FloatTok{0.1}\NormalTok{,}\DecValTok{30}\NormalTok{,}\AttributeTok{by=}\FloatTok{0.01}\NormalTok{)}

\NormalTok{  allmeans}\OtherTok{\textless{}{-}}\FunctionTok{matrix}\NormalTok{(}\DecValTok{0}\NormalTok{, }\AttributeTok{nrow=}\FunctionTok{length}\NormalTok{(tau\_seq),}\AttributeTok{ncol=}\FunctionTok{nrow}\NormalTok{(school))}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(school))\{  }
\NormalTok{ aa}\OtherTok{\textless{}{-}}\FunctionTok{sapply}\NormalTok{(tau\_seq,}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{conditionalExpectation}\NormalTok{(school}\SpecialCharTok{$}\NormalTok{sigma2j[i],school}\SpecialCharTok{$}\NormalTok{yj[i],}\AttributeTok{tau2=}\NormalTok{x}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{,school}\SpecialCharTok{$}\NormalTok{sigma2j,school}\SpecialCharTok{$}\NormalTok{yj))}
\NormalTok{ allmeans[,i]}\OtherTok{\textless{}{-}}\NormalTok{aa}
\NormalTok{\} }
  
\FunctionTok{plot}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{1}\NormalTok{],}\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{5}\NormalTok{,}\DecValTok{30}\NormalTok{),}\AttributeTok{ylab=}\StringTok{\textquotesingle{}Estimated Treatment Effects\textquotesingle{}}\NormalTok{, }\AttributeTok{xlab=}\StringTok{\textquotesingle{}tau\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{2}\NormalTok{],}\AttributeTok{col=}\StringTok{\textquotesingle{}green\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{3}\NormalTok{],}\AttributeTok{col=}\StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{4}\NormalTok{],}\AttributeTok{col=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{5}\NormalTok{],}\AttributeTok{col=}\StringTok{\textquotesingle{}yellow\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{6}\NormalTok{],}\AttributeTok{col=}\StringTok{\textquotesingle{}purple\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{7}\NormalTok{],}\AttributeTok{col=}\StringTok{\textquotesingle{}orange\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(tau\_seq,allmeans[,}\DecValTok{8}\NormalTok{],}\AttributeTok{col=}\StringTok{\textquotesingle{}brown\textquotesingle{}}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ V\_mu}\OtherTok{\textless{}{-}}\ControlFlowTok{function}\NormalTok{(allsigma2j,tau2)\{}
\NormalTok{   vinv}\OtherTok{\textless{}{-}}\FunctionTok{sum}\NormalTok{( }\DecValTok{1}\SpecialCharTok{/}\NormalTok{(allsigma2j}\SpecialCharTok{+}\NormalTok{tau2))}
\NormalTok{   vmu}\OtherTok{=}\DecValTok{1}\SpecialCharTok{/}\NormalTok{vinv}
   \FunctionTok{return}\NormalTok{(vmu)}
\NormalTok{ \}}

\NormalTok{conditionalVariance}\OtherTok{\textless{}{-}}\ControlFlowTok{function}\NormalTok{(sigma2j, tau2,allsigma2j)\{}
\NormalTok{  vmu}\OtherTok{\textless{}{-}}\FunctionTok{V\_mu}\NormalTok{(allsigma2j,tau2)}
\NormalTok{  Vj }\OtherTok{=} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{sigma2j}\SpecialCharTok{+}\DecValTok{1}\SpecialCharTok{/}\NormalTok{tau2) }
\NormalTok{  cond.var}\OtherTok{\textless{}{-}}\NormalTok{Vj}\SpecialCharTok{+}\NormalTok{Vj}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{tau2)}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{*}\NormalTok{vmu}
  \FunctionTok{return}\NormalTok{(cond.var)}
\NormalTok{\}}

\NormalTok{tau\_seq }\OtherTok{=} \FunctionTok{seq}\NormalTok{(}\FloatTok{0.1}\NormalTok{,}\DecValTok{30}\NormalTok{,}\AttributeTok{by=}\FloatTok{0.01}\NormalTok{)}

\NormalTok{  allsd}\OtherTok{\textless{}{-}}\FunctionTok{matrix}\NormalTok{(}\DecValTok{0}\NormalTok{, }\AttributeTok{nrow=}\FunctionTok{length}\NormalTok{(tau\_seq),}\AttributeTok{ncol=}\FunctionTok{nrow}\NormalTok{(school))}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(school))\{  }
\NormalTok{ aa}\OtherTok{\textless{}{-}}\FunctionTok{sapply}\NormalTok{(tau\_seq,}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{conditionalVariance}\NormalTok{(school}\SpecialCharTok{$}\NormalTok{sigma2j[i],}\AttributeTok{tau2=}\NormalTok{x}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{,school}\SpecialCharTok{$}\NormalTok{sigma2j))}
\NormalTok{ allsd[,i]}\OtherTok{\textless{}{-}}\FunctionTok{sqrt}\NormalTok{(aa)}
\NormalTok{\} }
