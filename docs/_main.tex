...
\begin{verbatim}
##       5%      25%      50%      75%      95% 
## 138.7898 156.0673 166.8126 178.4918 192.5139
\end{verbatim}
...
## -283.6159   -0.5427    0.4729    0.9248    1.5253  527.5653
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    4.00   20.00   23.50   23.76   27.00   45.00
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   4.581  20.792  24.273  24.267  27.705  50.993
\end{verbatim}
...
\begin{verbatim}
## average predictive value from posterior:23.759
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   607.0   670.0   690.0   690.2   709.0   785.0
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2125  0.4412  0.5304  0.5472  0.6424  1.1843
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2271  0.4506  0.5509  0.5674  0.6657  1.1602
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2480  0.4614  0.5535  0.5775  0.6632  1.1821
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.1590  0.4614  0.5572  0.5699  0.6525  1.4702
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.3644  0.5112  0.5652  0.5745  0.6316  0.9265
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   6.791   9.446  10.345  10.404  11.273  16.366
\end{verbatim}
...
\begin{verbatim}
## posterior mean for A :1.313 B 11.639
\end{verbatim}
...
\begin{verbatim}
## normal approx posterior mean -0.102 std. dev 0.108
\end{verbatim}
...
\begin{verbatim}
## sample posterior mean: -0.104859
\end{verbatim}
...
\begin{verbatim}
## simulated mean/std.dev: 0.795 0.642
\end{verbatim}
