...
\begin{verbatim}
##       5%      25%      50%      75%      95% 
## 139.4638 155.5763 167.0008 177.2288 194.6336
\end{verbatim}
...
## -161.2108   -0.5990    0.4959    0.8502    1.4840  375.7766
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    8.00   20.00   24.00   23.83   27.00   48.00
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   3.164  20.806  24.262  24.254  27.732  49.729
\end{verbatim}
...
\begin{verbatim}
## average predictive value from posterior:23.8257
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   594.0   670.8   690.0   689.9   708.0   792.0
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.1892  0.4294  0.5269  0.5453  0.6433  1.3319
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2562  0.4451  0.5479  0.5558  0.6440  1.0533
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2156  0.4591  0.5554  0.5761  0.6698  1.2152
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.2338  0.4581  0.5500  0.5726  0.6758  1.3141
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##  0.3254  0.5044  0.5604  0.5661  0.6207  0.9436
\end{verbatim}
...
\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   6.522   9.469  10.443  10.456  11.403  15.579
\end{verbatim}
...
\begin{aligned}
 ...
 & = (1/N) \prod {N \choose y_i} Beta(S, nN-S)
\end{aligned}
\]
The maximum probability is 122 trials with the highest marginal, and for P\((N>100)\geq 0.99\) so we are very certain that there were greater than 100 trials.
...
\begin{Highlighting}[]
  \DocumentationTok{\#\#}
\FunctionTok{plot}\NormalTok{(totalN,marg.n)}
